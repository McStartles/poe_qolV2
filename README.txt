...
The CLI command to compile the exe with pyinstaller requires the 'hidden-imports' flag. Use the following command:
pyinstaller --hidden-import=pygubu.builder.ttkstdwidgets --onefile POE_QOL2.py
